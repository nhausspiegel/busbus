 ...
 *
 *  Default case is Address J <-> Trader Joe's on South Main, run in
...
const ADDRESS_J = { lat: 41.8278062, lng: -71.4024241, label: "Address J" };
...
const pairs = a && b ? [[a, b]] : [[ADDRESS_J, TRADER_JOES], [TRADER_JOES, ADDRESS_J]];
